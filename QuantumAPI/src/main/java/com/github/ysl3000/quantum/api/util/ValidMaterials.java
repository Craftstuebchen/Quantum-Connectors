package com.github.ysl3000.quantum.api.util;
...
public class ValidMaterials {
    ...
    public final static List<Material> validReceivers = ValidMaterials.join(
            ...
            ValidMaterials.LAMP,
            ValidMaterials.LEVER,
            ValidMaterials.RAIL,
            ValidMaterials.PISTON);
    ...
    public static List<Material> join(List<Material>... lists) {
        List<Material> materials = new ArrayList<>();

        for (List<Material> mat : lists)
            materials.addAll(mat);
        return materials;
    }
}
